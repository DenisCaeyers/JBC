...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
	...
	<SharePointWebControls:CssRegistration name="<% $SPUrl:~sitecollection/_catalogs/masterpage/JBC/CSS/jbc-HR4MeOverviewPageLayout.css %>" After="corev15.css" runat="server"/>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="jbc-pageimage">
				<WebPartPages:WebPartZone id="g_D82265B6E37E4C6984C0C394AA49949E" runat="server" title="Page Image zone"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
			</div>
		</div>
	</div>
	<div class="row">
