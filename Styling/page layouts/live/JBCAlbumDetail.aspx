...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
	...
	<SharePointWebControls:CssRegistration name="<% $SPUrl:~sitecollection/_catalogs/masterpage/JBC/CSS/jbc-SingleColumnPageLayout.css %>" After="corev15.css" runat="server"/>
	
	<!-- TODO Change to local files -->
	<script src="https://code.jquery.com/jquery-2.1.4.min.js" type="text/javascript"></script>
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://jbcbe.sharepoint.com/_catalogs/masterpage/JBC/CSS/lightbox.css">	
    ...
    <script src="https://jbcbe.sharepoint.com/_catalogs/masterpage/JBC/JS/jbc-albumdetail.js" type="text/javascript"></script>
    <script src="https://jbcbe.sharepoint.com/_catalogs/masterpage/JBC/JS/lightbox.js" type="text/javascript"></script>
...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <a class="jbc-link" href="https://jbcbe.sharepoint.com/about/pictures/Pages/home.aspx">Back to albums</a>
        </div>
    </div>	
    <div class="row">
        <div id="jbc-albumdetail"></div>
    </div>
    
	<div class="row">
		<div class="col-md-12">
			<WebPartPages:WebPartZone id="g_D82265B6E37E4C6984C0C394AA49949D" runat="server" title="Main zone"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
		</div>
	</div>
