...
<asp:Content ContentPlaceholderID="PlaceHolderAdditionalPageHead" runat="server">
	...
	<SharePointWebControls:CssRegistration name="<% $SPUrl:~sitecollection/_catalogs/masterpage/JBC/CSS/jbc-DoubleColumnPageLayout.css %>" After="corev15.css" runat="server"/>
...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<WebPartPages:WebPartZone id="g_D82265B6E37E4C6984C0C394AA49949E" runat="server" title="Main zone"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
		</div>
	</div>
